...
export default function Home() {
  ...
  const handleSuggestedQuestion = (
    question: keyof typeof predefinedResponses
  ) => {
  ...
  useEffect(() => {
    ...
    const timeouts = [
      ...
      setTimeout(
        () => setIsVisible((prev) => ({ ...prev, vertex0: true })),
        600
      ),
      setTimeout(
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-white via-purple-50/10 to-cyan-50/10 relative overflow-hidden">
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-sm animate-slideDown flex h-16 items-center justify-between">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              ...
              >
                ...
                <div
                  className="flex flex-col gap-2 min-[400px]:flex-row animate-fadeInUp"
              ...
              <div
                className={`mx-auto lg:mx-0 relative transition-all duration-1000 ${
                  isVisible.vertex0
                ...
                <div className="relative bg-gradient-to-br from-violet-50/90 via-purple-50/80 to-fuchsia-50/90 backdrop-blur-sm p-8 rounded-2xl shadow-xl border-2 border-violet-200/50">
                  ...
                  {showChat && (
                    <>
                      ...
                      <div className="space-y-4 max-h-[300px] overflow-y-auto custom-scrollbar">
                        {messages.map((message, index) => (
                          <div
                            ...
                            } p-4 rounded-xl transition-all duration-300 hover:shadow-md animate-messageSlide`}
                      ...
                      {messages.length < 4 && (
                        <div
                          className="mt-4 space-y-2 animate-fadeInUp"
                              ...
                              <button
                                ...
                                onClick={() =>
                                  handleSuggestedQuestion(
                                    question as keyof typeof predefinedResponses
                                  )
                                }
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-3 mt-12">
              {[
                ...
                <div
                  key={index}
                  className={`flex flex-col items-center text-center p-6 rounded-xl transition-all duration-1000 cursor-pointer animate-fadeInUp ${
                    hoverCard === index
                ...
                >
                  <div
                    className={`flex h-16 w-16 items-center justify-center rounded-full bg-purple-100 text-purple-900 font-bold text-xl transition-all duration-500 ${
                      activeStep === index
