...
import { ChevronLeft, ChevronRight, Play, ArrowRight, BookOpen, CheckCircle2, Lock } from "lucide-react"
...
import GraphoAssistant from "@/components/ui/llm"
  ...
  const units = [
    {
      ...
      description: "Learn the basic concepts of graph theory essential for understanding Dijkstra's algorithm.",
      lessons: [
    ...
    },
    {
      ...
      description: "Understand the problem that Dijkstra's algorithm solves and its real-world applications.",
      lessons: [
    ...
    },
    {
      ...
      description: "Explore the greedy approach and the core principles behind Dijkstra's algorithm.",
      lessons: [
    ...
    },
    {
      ...
      description: "Learn about the data structures that make Dijkstra's algorithm efficient.",
      lessons: [
    ...
    },
    {
      ...
      description: "Walk through the complete execution of Dijkstra's algorithm step by step.",
      lessons: ["Initialization Phase", "Main Loop Execution", "Path Reconstruction", "Termination Conditions"],
      progress: 0,
      unlocked: false,
    },
    {
      ...
      description: "Apply Dijkstra's algorithm to solve real problems and learn debugging techniques.",
      lessons: [
    ...
    },
    {
      ...
      description: "Master Dijkstra's algorithm through a comprehensive project and explore variations.",
      lessons: [
      ...
      <header className="border-b border-slate-700 bg-[#1e293b] px-4 py-2 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium">dijkstra-learning.com/learning</span>
          </div>
        </div>
        <div className="flex items-center space-x-2">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-80 bg-[#1e293b] border-r border-slate-700 flex flex-col">
          <div className="p-4 border-b border-slate-700">
            ...
            <p className="text-sm text-slate-300">Master the fundamentals of pathfinding</p>
          </div>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="flex items-center">
                          ...
                          {!unit.unlocked && <Lock className="h-3 w-3 ml-2 text-slate-400" />}
                        </div>
                        <Progress value={unit.progress} className="h-1 mt-1 bg-slate-700" />
                      </div>
                    </div>
                        ...
                        {unit.lessons.map((lesson, index) => (
                          <div
                            ...
                            className={`flex items-center justify-between p-2 hover:bg-slate-700 rounded-md cursor-pointer ${
                              selectedUnit === unit.id && index === 0 ? "bg-slate-700" : ""
                            }`}
                          ...
                          >
                            ...
                            {unit.progress > (index / unit.lessons.length) * 100 && (
          ...
          <div className="p-4 border-t border-slate-700">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-slate-400">3 of 7 units started</div>
              </div>
        ...
        <div className="flex-1 flex overflow-hidden">
          {selectedUnit !== null ? (
              ...
              <Tabs defaultValue="overview" className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-hidden">
                  ...
                  >
                    <ScrollArea className="flex-1">
                      <div className="p-8 max-w-4xl mx-auto">
                        ...
                        <p className="text-lg text-slate-300 mb-6">{units[selectedUnit].description}</p>

                        <div className="bg-[#1e293b] rounded-lg p-6 mb-8">
                          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div className="mb-4 md:mb-0">
                              <h2 className="text-lg font-bold">Prefer to watch and learn?</h2>
                              <p className="text-sm text-slate-300">I can turn this into a video for you!</p>
                            </div>
                        ...
                        <div className="prose prose-invert max-w-none">
                          ...
                          <p>Before starting this unit, you should have a basic understanding of:</p>
                          <ul className="space-y-1">
                            <li>Basic programming concepts</li>
                            {selectedUnit > 0 && <li>Content from Unit {selectedUnit - 1}</li>}
                            {selectedUnit > 1 && <li>Graph representation in code</li>}
                            {selectedUnit > 2 && <li>Greedy algorithm principles</li>}
                          </ul>

                          <h2 className="text-2xl font-bold mt-8 mb-4">Unit Overview</h2>
                          <p>
                            {selectedUnit === 0 &&
                            ...
                            <div key={index} className="bg-[#1e293b] rounded-lg overflow-hidden">
                              <div className="p-6">
                                <div className="flex items-center justify-between mb-4">
                                  ...
                                  {units[selectedUnit].progress > (index / units[selectedUnit].lessons.length) * 100 ? (
                                ...
                                <p className="text-slate-300 mb-4">
                                  Learn about {lesson.toLowerCase()} and how it relates to Dijkstra's algorithm.
                                </p>
                                <div className="flex items-center text-sm text-slate-400">
                                  <span>Estimated time: 15-20 min</span>
                                  <span className="mx-2">•</span>
                                  <span>Includes: Video, Text, Interactive Examples</span>
                                </div>
                              </div>
                              <div className="bg-[#172136] p-4 flex justify-between items-center">
                                <div className="flex items-center">
                                  <Play className="h-4 w-4 mr-2 text-blue-400" />
                                  <span className="text-sm text-blue-400">Watch Introduction</span>
                                </div>
                                <Button className="bg-blue-600 hover:bg-blue-700">
                                  {units[selectedUnit].progress > (index / units[selectedUnit].lessons.length) * 100
                                    ? "Review Lesson"
                  ...
                  >
                    <ScrollArea className="flex-1">
                      <div className="p-8 max-w-4xl mx-auto">
                        <h1 className="text-3xl font-bold mb-6">Practical Exercises</h1>
                        <p className="text-lg text-slate-300 mb-8">
                          Apply what you've learned in Unit {selectedUnit} with these hands-on exercises.
                        </p>

                        <div className="space-y-6">
                          <div className="bg-[#1e293b] rounded-lg overflow-hidden">
                            <div className="p-6">
                              <h2 className="text-xl font-bold mb-2">Exercise 1: Implementation Challenge</h2>
                              <p className="text-slate-300 mb-4">
                                Implement the core functionality discussed in this unit and test it with provided
                                examples.
                              </p>
                              <Badge className="bg-yellow-600">Intermediate</Badge>
                            </div>
                            <div className="bg-[#172136] p-4 flex justify-end">
                              <Button className="bg-blue-600 hover:bg-blue-700">Start Exercise</Button>
                            </div>
                          </div>

                          <div className="bg-[#1e293b] rounded-lg overflow-hidden">
                            <div className="p-6">
                              <h2 className="text-xl font-bold mb-2">Exercise 2: Debugging Challenge</h2>
                              <p className="text-slate-300 mb-4">
                                Find and fix bugs in a provided implementation related to this unit's concepts.
                              </p>
                          ...
                          <div className="bg-[#1e293b] rounded-lg overflow-hidden">
                            <div className="p-6">
                              <h2 className="text-xl font-bold mb-2">Exercise 3: Visualization Task</h2>
                              <p className="text-slate-300 mb-4">
                                Create a visual representation of the concepts learned in this unit.
                              </p>
                  ...
                  >
                    <ScrollArea className="flex-1">
                      <div className="p-8 max-w-4xl mx-auto">
                        <h1 className="text-3xl font-bold mb-6">Knowledge Check</h1>
                        <p className="text-lg text-slate-300 mb-8">
                          Test your understanding of Unit {selectedUnit} with this quiz.
                        </p>

                        <div className="bg-[#1e293b] rounded-lg p-6 mb-6">
                          <div className="flex justify-between items-center mb-4">
                            <h2 className="text-xl font-bold">Unit {selectedUnit} Quiz</h2>
                            <div className="flex items-center">
                              <span className="text-sm text-slate-300 mr-2">10 questions</span>
                              <span className="text-sm text-slate-300">•</span>
                              <span className="text-sm text-slate-300 ml-2">15 minutes</span>
                            </div>
                          </div>
                          <p className="text-slate-300 mb-6">
                            This quiz covers all the key concepts from Unit {selectedUnit}. You need to score at least
                            70% to pass.
                          </p>
                          <Button className="bg-blue-600 hover:bg-blue-700 w-full">Start Quiz</Button>
                        </div>
                        ...
                        <div className="bg-[#1e293b] rounded-lg p-6">
                          ...
                          <ul className="space-y-2 text-slate-300">
                            ...
                            <li>Questions will be randomized from a larger pool</li>
            ...
            <div className="flex-1 overflow-auto">
              <div className="p-8 max-w-4xl mx-auto">
                <h1 className="text-3xl font-bold mb-6">Welcome to Dijkstra's Algorithm Course</h1>

                <div className="bg-[#1e293b] rounded-lg p-6 mb-8">
                  <div className="flex items-start">
                    <Avatar className="h-12 w-12 mr-4">
                      <AvatarImage src="/placeholder.svg?height=48&width=48" alt="Grapho" />
                      <AvatarFallback className="bg-blue-600">G</AvatarFallback>
                    </Avatar>
                    <div>
                      <p className="text-sm font-semibold mb-1">
                        Grapho <span className="text-slate-400 text-xs">Just now</span>
                      </p>
                      <p className="text-sm">
                        👋 Welcome to the Dijkstra's Algorithm learning path! I'm Grapho, your AI learning assistant.
                        This course will take you from the basics of graph theory all the way to mastering Dijkstra's
                        algorithm and its variations. Select a unit from the sidebar to begin your journey!
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-lg text-slate-300 mb-6">
                  This comprehensive course on Dijkstra's algorithm is structured into 7 units, each building upon the
                  previous one:
                </p>
                    ...
                    <div key={unit.id} className="bg-[#1e293b] rounded-lg p-6">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-slate-300 mb-3">{unit.description}</p>
                          <div className="flex items-center">
                            <Progress value={unit.progress} className="w-32 h-2 mr-3 bg-slate-700" />
                            <span className="text-sm text-slate-400">{unit.progress}% complete</span>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button className="bg-blue-600 hover:bg-blue-700" onClick={() => selectUnit(2)}>
                    Continue Unit 2
                    <ArrowRight className="h-4 w-4 ml-2" />
                  </Button>
                </div>
